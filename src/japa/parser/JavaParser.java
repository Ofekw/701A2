 ...
 * @author J�lio Vilmar Gesser (jgesser@gmail.com) - bug fixes and added AST generation
 */
 ...
 */
  final public CompilationUnit CompilationUnit() throws ParseException {
    ...
    {if (true) return new CompilationUnit(line == -1 ? 0 : line, column, pakage, imports, types, getComments());}
  ...
  final public PackageDeclaration PackageDeclaration() throws ParseException {
    ...
    {if (true) return new PackageDeclaration(line, column, annotations, name);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public ImportDeclaration ImportDeclaration() throws ParseException {
    ...
    jj_consume_token(SEMICOLON);
    {if (true) return new ImportDeclaration(line, column, name, isStatic, isAsterisk);}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  ...
  final public ClassOrInterfaceDeclaration ClassOrInterfaceDeclaration(Modifier modifier) throws ParseException {
   ...
   int column = 0;
    ...
    {if (true) return new ClassOrInterfaceDeclaration(line, column, popJavadoc(), modifier.modifiers, modifier.annotations, isInterface, name, typePar, extList, impList, members);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public EnumDeclaration EnumDeclaration(Modifier modifier) throws ParseException {
    ...
    {if (true) return new EnumDeclaration(line, column, popJavadoc(), modifier.modifiers, modifier.annotations, name, impList, entries, members);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public EnumConstantDeclaration EnumConstantDeclaration() throws ParseException {
    ...
    {if (true) return new EnumConstantDeclaration(line, column, popJavadoc(), annotations, name, args, classBody);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FieldDeclaration FieldDeclaration(Modifier modifier) throws ParseException {
    ...
    jj_consume_token(SEMICOLON);
    {if (true) return new FieldDeclaration(type.getBeginLine(), type.getBeginColumn(), popJavadoc(), modifier.modifiers, modifier.annotations, type, variables);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public MethodDeclaration MethodDeclaration(Modifier modifier) throws ParseException {
    ...
    {if (true) return new MethodDeclaration(line, column, popJavadoc(), modifier.modifiers, modifier.annotations, typeParameters, type, name, parameters, arrayCount, throws_, block);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public ConstructorDeclaration ConstructorDeclaration(Modifier modifier) throws ParseException {
    ...
    jj_consume_token(RBRACE);
        ...
        {if (true) return new ConstructorDeclaration(line, column, popJavadoc(), modifier.modifiers, modifier.annotations, typeParameters, name, parameters, throws_, new BlockStmt(bbLine, bbColumn, beLine, beColumn, stmts));}
    throw new Error("Missing return statement in function");
  }
  ...
  final public List StatementsYield(String name) throws ParseException {
        List ret = null;
        Statement stmt;
    label_18:
    while (true) {
  ...
  final public InitializerDeclaration InitializerDeclaration() throws ParseException {
    ...
    {if (true) return new InitializerDeclaration(line, column, popJavadoc(), isStatic, block);}
    throw new Error("Missing return statement in function");
  }
    ...
    case SUPER:
      ...
      default:
        ...
        ;
                        ...
                        ret = hasArgs
                                ? new MethodCallExpr(line, column, ret, typeArgs, name, args, block)
        ...
        case IDENTIFIER:
          ...
          default:
            ...
            ;
                        ...
                        ret = hasArgs
                                ? new MethodCallExpr(line, column, null, null, name, args, block)
        ...
        if (jj_2_29(2147483647)) {
          ...
          default:
            ...
            ;
                        ...
                        ret = hasArgs
                                ? new MethodCallExpr(line, column, scope, typeArgs, name, args, block)
 ...
 */
  ...
  final public Statement StatementYeild(String name) throws ParseException {
        Statement ret;
    if (jj_2_35(2)) {
      ret = LabeledStatement();
    } else {
  ...
  final public YieldStmt YieldStatement(String name) throws ParseException {
    ...
    jj_consume_token(SEMICOLON);
    {if (true) return new YieldStmt(line, column, id);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public BlockStmt BlockYield(String name) throws ParseException {
        List stmts;
        int beginLine;
        int beginColumn;
        int endLine;
  ...
  final public BlockStmt AnonymousBlock() throws ParseException {
        List stmts;
        int beginLine;
        int beginColumn;
        int endLine;
 ...
 */
  final public Statement BlockStatementYield(String name) throws ParseException {
        Statement ret;
        Expression expr;
...
/* Annotation Types. */
  final public AnnotationDeclaration AnnotationTypeDeclaration(Modifier modifier) throws ParseException {
    ...
    {if (true) return new AnnotationDeclaration(line, column, popJavadoc(), modifier.modifiers, modifier.annotations, name, members);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public AnnotationMemberDeclaration AnnotationTypeMemberDeclaration(Modifier modifier) throws ParseException {
    ...
    jj_consume_token(SEMICOLON);
          {if (true) return new AnnotationMemberDeclaration(type.getBeginLine(), type.getBeginColumn(), popJavadoc(), modifier.modifiers, modifier.annotations, type, name, defaultVal);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x48101000,0x1,0x0,0x0,0x0,0x40001000,0x8100000,0x48101000,0x100000,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x4a195000,0x0,0x0,0x0,0x0,0x0,0x10000000,0x0,0x4a195000,0x8100000,0x2094000,0x4a195000,0x0,0x0,0x0,0x22094000,0x22094000,0x0,0x0,0x0,0x0,0x0,0x0,0x42095000,0x0,0x0,0x0,0x0,0x0,0x22094000,0x6359f000,0x6359f000,0x0,0x2094000,0x2094000,0x0,0x2094000,0x10000000,0x10000000,0x2094000,0x2094000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x22094000,0x0,0x0,0x22094000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x20000000,0x22094000,0x0,0x0,0x0,0x2094000,0x0,0x0,0x2349e000,0x2349e000,0x0,0x0,0x2349e000,0x2349e000,0x0,0x0,0x0,0x22094000,0x820000,0x820000,0x4000000,0x62095000,0x22094000,0x22094000,0x62095000,0x22094000,0x0,0x0,0x0,0x22094000,0x40000,0x80000000,0x80040000,0x0,0x0,0x0,0x22094000,0x22094000,0x0,0x4a195000,0xa194000,0x4a195000,0x800000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x20,0x8899c500,0x0,0x0,0x80000,0x0,0x8899c400,0x100,0x8899c500,0x100,0x0,0x0,0x10,0x0,0x0,0x10,0x0,0x0,0xc89dc781,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc89dc781,0x100,0x40040281,0xc89dc781,0x0,0x0,0x0,0x51241a81,0x51241a81,0x0,0x0,0x0,0x4000000,0x0,0x0,0x889dc681,0x0,0x0,0x4000000,0x0,0x0,0x51241a81,0xfbffdf8b,0xfbffdf8b,0x80000,0x40281,0x40281,0x0,0x40281,0x200000,0x200000,0x40281,0x40040281,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x51241a81,0x0,0x0,0x51241a81,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x11201800,0x0,0x0,0x0,0x0,0x0,0x1000800,0x0,0x10001000,0x10000000,0x51241a81,0x0,0x0,0x0,0x40281,0x0,0x0,0x73e61a8b,0x73e61a8b,0x0,0x0,0x73e61a8b,0x73e61a8b,0x0,0x0,0x0,0x51241a81,0x0,0x0,0x0,0xd9bdde81,0x51241a81,0x51241a81,0xd9bdde81,0x51241a81,0x0,0x0,0x0,0x51241a81,0x0,0x0,0x0,0x0,0x0,0x0,0x51241a81,0x51241a81,0x0,0x889dc781,0x40381,0x889dc781,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x4800000,0x0,0x4000000,0x0,0x2000000,0x4000000,0x4000000,0x4800000,0x0,0x10000000,0x0,0x0,0x1000000,0x1000000,0x0,0x4004000,0x1000000,0x14884000,0x800000,0x4000000,0x20000,0x80000,0x1000000,0x0,0x0,0x14884000,0x4000000,0x10004000,0x14804000,0x1000000,0x8000000,0x200000,0x600a708c,0x600a708c,0x1000000,0x10000000,0x200000,0x0,0x880000,0x1000000,0x4004000,0x0,0x10000000,0x0,0x10000000,0x10000000,0x1002708c,0x48a708f,0x48a708f,0x0,0x0,0x4000,0x1000000,0x80004000,0x0,0x0,0x0,0x4000,0x1000000,0x8000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10000000,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x6002708c,0x60000000,0x60000000,0x2708c,0x20000,0x0,0x10000000,0x20000,0x80000,0x20000,0x80000,0x2308c,0x4000,0x2000000,0x10000000,0x20000,0x80000,0x0,0x2200000,0x308c,0x0,0x6002708c,0x1000000,0x10000000,0x220000,0x10004000,0x200000,0x200000,0x8a708f,0x8a708f,0x4000,0x0,0x8a708f,0x8a708f,0x1000000,0x8000000,0x8000000,0x2708c,0x0,0x0,0x0,0x6402708c,0x6002708c,0x6002708c,0x6482708c,0x6002708c,0x1000000,0x4000,0x4000,0x6002708c,0x0,0x0,0x0,0x4000000,0x4000,0x1000000,0x640a708c,0x640a708c,0x1000000,0x4804000,0x4004000,0x4804000,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x780,0x780,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x180,0x180,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1ffc0000,0x0,0x20,0x40,0x4000,0x8000,0x2000,0x12,0x12,0x0,0xc,0xc,0x20000,0x600,0x600,0x11800,0x11800,0x600,0x780,0x0,0x0,0x0,0x0,0x180,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x780,0x0,0x0,0x0,0x0,0x0,0x0,0x180,0x180,0x0,0x1,0x180,0x180,0x0,0x1ffc0180,0x1ffc0180,0x180,0x0,0x0,0x0,0x780,0x780,0x780,0x780,0x780,0x0,0x0,0x0,0x780,0x0,0x0,0x0,0x0,0x0,0x0,0x780,0x780,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x0,0x0,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
